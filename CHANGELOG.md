...
### Added
- Support for Grok 3 video generation model
- Support for Seedance models (Seedance 2 Remix and Seedance 2 Omni)

### Changed
- Dynamically resolves API endpoints to accommodate Grok and Seedance models
- Adjusted wait timeout polling limits based on the specific selected model
